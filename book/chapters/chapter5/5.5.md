...
<figure>
    ...
    <figcaption style="text-align: center;">
        Figure: Hillblock (photos courtesy Hillblock b.v.).
    </figcaption>
</figure>
...
<figure>
    <img src="./chapter5_figures/Checkerboard_roughness.jpg" 
         ...
         style="display: block; margin: 0 auto; width: 80%; height: auto;">
    <figcaption style="text-align: center;">
        Figure: Checkerboard roughness at the Hondsbossche Zeewering.
    </figcaption>
</figure>
...
<figure>
    <img src="./chapter5_figures/Definitions_Berm_Reductions.jpg" 
         ...
         style="display: block; margin: 0 auto; width: 80%; height: auto;">
    <figcaption style="text-align: center;">
        Figure: Definition Berm Reductions.
    </figcaption>
</figure>
...
<figure>
    <img src="./chapter5_figures/Definitions_schematization_average_slope.jpg" 
         ...
         style="display: block; margin: 0 auto; width: 80%; height: auto;">
    <figcaption style="text-align: center;">
        Figure: Definitions schematization average slope.
    </figcaption>
</figure>
...
<figure>
    <img src="./chapter5_figures/muralt_wall_zeeland.jpg" 
         ...
         style="display: block; margin: 0 auto; width: 80%; height: auto;">
    <figcaption style="text-align: center;">
        Figure: Muralt wall in Zeeland (Wikipedia Commons, A. van der Linde).
    </figcaption>
</figure>
