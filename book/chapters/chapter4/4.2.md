...
<figure style="display: flex; flex-direction: row; justify-content: space-between; margin: 1em auto;">
    <div style="flex: 1; padding-right: 1em;">
        <p style="text-align: justify;">
            Where the water levels as a result from the astronomic tide can be calculated in advance, the actual water levels along the coast depend on the weather conditions...
        </p>
    </div>
    <div style="flex: 0 0 30%; text-align: center;">
        ...
        <figcaption style="text-align: center; font-size: 0.9em;">Figure 4.5: Storm water levels in Flushing (Vlissingen) in 120 years from 1887.</figcaption>
    </div>
</figure>
