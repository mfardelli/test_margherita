...
<figure style="float: right; width: 40%; margin: 0 0 1em 1em;">
    ...
    <figcaption style="text-align: center;">
        Figure: The wave characteristic definitions
    </figcaption>
</figure>
...
<figure style="text-align: center; margin: 1em auto;">
    ...
    <figcaption style="text-align: center;">
        Figure: Counting the number of waves with different heights yields a graph that looks like a wave energy spectrum with wave periods (or frequencies).
    </figcaption>
</figure>
...
<figure style="text-align: center; margin: 1em auto;">
    <img src="./chapter4_figures/wave_spectrum.jpg" 
         ...
         style="display: block; margin: 0 auto; width: 80%; height: auto;">
    <figcaption style="text-align: center;">
        Figure: A wave spectrum is a representation of the combination of waves from different origin occurring at one measuring point. It distinguishes all the different waves in the combination by the frequency <em>f</em> (=1/T).
    </figcaption>
</figure>
...
<figure style="float: right; width: 40%; margin: 0 0 1em 1em; text-align: center;">
    <img src="./images/Wind_speed_Northsea.jpg" 
    ...
    <figcaption style="text-align: center; font-size: 0.9em;">
        Figure: Wind speeds in the North Sea. In the logarithmic Gumbel distribution, maximum wind speeds seem to arrive at a maximum of Beaufort 12 >32.7 m/s at a return period of T = 10,000 years (Source KNMI).
    </figcaption>
</figure>
