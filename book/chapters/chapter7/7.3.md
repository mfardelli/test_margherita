...
In contrast to the berms, which act essentially as counter-weights for the pore water pressures in the subsoil, drainage systems with or without filters try to release these pressures under controlled conditions, such that no erosion can take place. Figure [7.10](fig-drainge-trench) shows an example of a drainage trench at the landside toe with a filter covering the bottom of the trench.

(fig-drainge-trench)=
<figure>
    <img src="./chapter7_figures/drainage_trench.jpg" 
         alt="Illustration of a drainage trench with a granular filter covering the bottom of the trench; source: {cite}`USACE2005`" 
         style="display: block; margin: 0 auto; width: 80%; height: auto;">
    <figcaption style="text-align: center;">
        Figure 7.10: Illustration of a drainage trench with a granular filter covering the bottom of the trench; source: {cite}`USACE2005`.
    </figcaption>
</figure>
...
## 7.3.3. Relief wells
Relief wells are a special category of drainage systems. The wells are inserted in the ground vertically by drilling techniques in order to permeate the aquifer. The seepage water then flows towards and into the relief well, thus relieving the pore water pressure (piezometric head) in the aquifer (see Figure [7.11](fig-relief-wells)). 

(fig-relief-wells)=
<figure>
    <img src="./chapter7_figures/relief_wells_schematic.jpg" 
         alt="Schematic representation of the groundwater flow towards a well and the effect on the piezometric head or phreatic surface" 
         style="display: inline-block; width: 48%; height: auto;">
    <img src="./chapter7_figures/relief_wells_field.jpg" 
         alt="Relief wells draining water at the toe of the levee northwest of Vicksburg" 
         style="display: inline-block; width: 48%; height: auto;">
    <figcaption style="text-align: center;">
        Figure 7.11: Relief wells: schematic representation of the groundwater flow towards a well and the effect on the piezometric head or phreatic surface (left, source: USACE (1986)); relief wells draining water at the toe of the levee northwest of Vicksburg (source: nola.com).
    </figcaption>
</figure>
...
<figure>
    <img src="./chapter7_figures/CutOffWall.jpg" 
         alt="Example of a cut-off wall in the center of a dike cross section. Source: International Levee Handbook {cite}`LeveeHandbook`" 
         style="display: block; margin: 0 auto; width: 80%; height: auto;">
    <figcaption style="text-align: center;">
        Figure 7.12: Example of a cut-off wall in the center of a dike cross section. Source: International Levee Handbook {cite}`LeveeHandbook`.
    </figcaption>
</figure>
