(sec-function-of-flood-defences)=
...
## 1.4.2 Living and working functions
...
<figure>
    <div style="display: flex; justify-content: space-between; gap: 10px;">
        ...
        <div style="flex: 0 0 48%; text-align: center;">
            <img src="./chapter1_figures/Apartment_on_eroding_dunes.jpg" 
...
## 1.4.6 Landscape, nature and cultural values
...
<figure>
    <div style="display: flex; justify-content: space-between; gap: 10px;">
        <div style="flex: 0 0 45%; text-align: center;">
            <img src="./chapter1_figures/vegetation_on_dike_slope.jpg" 
