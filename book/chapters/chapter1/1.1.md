...
<figure>
    <img src="./chapter1/chapter1_figures/Types_primary_flood_Defences.jpeg" 
    ...
    <figcaption style="text-align: center; font-style: italic; font-size: small; margin-top: 5px;">
        <strong>Figure 1.2:</strong> Types of primary flood defences in the Netherlands 
        (Inspectie Verkeer en Waterstaat, 2011).
    </figcaption>
</figure>
