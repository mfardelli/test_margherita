(sec-dikes-basic-tecnhical-aspects)=
...
<figure>
    ...
    <figcaption style="text-align: center; font-size: small; margin-top: 5px;">
        Figure 1.3: General dike profile showing the most important elements of a dike.
    </figcaption>
</figure>
...
## 1.3.2 Dike designs
(fig-sea-dike-reinforcement-temp)=
The chosen dimensions of a dike will strongly depend on the design loads. For sea dikes due to the high waves formed during a storm at sea, a shallow outer slope, an outer berm and / or a dike revetment of stones or asphalt can be applied. [Figure 1.4](#fig-sea-dike-reinforcement) shows an example of sea dike constructed out of a core of sand with a cover layer of clay, and asphalt and concrete revetments at locations where wave attack can be expected.

(fig-profile-of-river-dike-temp)=
The waves along the rivers are generally smaller and outer berms are not applied. For river dikes an inner berm or a relatively flat inner slope is applied (usually smaller than 1 over 3) to provide sufficient stability during long periods of high water. [Figure 1.5](#fig-profile-of-river-dike) shows an example of a river dike with an inner berm and a core of sand. When dimensioning a dike, the footprint and the land use in the surroundings should be taken into consideration (see also [section1.5]).
...
<figure>
    <img src="./chapter1_figures/sea_dike_reinforcement.jpeg" 
         ...
         style="display: block; margin: 0 auto; width: 80%; height: auto;">
    <figcaption style="text-align: center; font-size: small; margin-top: 5px;">
        Figure 1.4: Example of a profile of a sea dike reinforcement.
    </figcaption>
</figure>
...
<figure>
    <img src="./chapter1_figures/profile_of_river_dike.jpeg" 
         ...
         style="display: block; margin: 0 auto; width: 80%; height: auto;">
    <figcaption style="text-align: center; font-size: small; margin-top: 5px;">
        Figure 1.5: Example of a profile of a river dike (<cite>Leusen Velden</cite>).
    </figcaption>
</figure>
