...
<figure>
    <img src="./chapter1_figures/sea_dike_reinforcement.jpeg" 
         ...
         style="display: block; margin: 0 auto; width: 80%; height: auto;">
    <figcaption style="text-align: center; font-style: italic; font-size: small; margin-top: 5px;">
        <strong>Figure 1.4</strong>: Example of a profile of a sea dike reinforcement.
    </figcaption>
</figure>
...
<figure>
    <img src="./chapter1_figures/profile_of_river_dike.jpeg" 
         ...
         style="display: block; margin: 0 auto; width: 80%; height: auto;">
    <figcaption style="text-align: center; font-style: italic; font-size: small; margin-top: 5px;">
        <strong>Figure 1.5</strong>: Example of a profile of a river dike (<cite>Leusen Velden</cite>).
    </figcaption>
</figure>
...
<figure>
    <img src="./chapter1_figures/Dike_with_pile_coffer.jpeg" 
         ...
         style="display: block; margin: 0 auto; width: 80%; height: auto;">
    <figcaption style="text-align: center; font-style: italic; font-size: small; margin-top: 5px;">
        <strong>Figure 1.6</strong>: Dike with pile coffer (<cite>Agema, 1982</cite>).
    </figcaption>
</figure>
...
<figure>
    <img src="./chapter1_figures/vietnamese_sea_dike.jpeg" 
         ...
         style="display: block; margin: 0 auto; width: 80%; height: auto;">
    <figcaption style="text-align: center; font-style: italic; font-size: small; margin-top: 5px;">
        <strong>Figure 1.7</strong>: Typical cross section of a Vietnamese sea dike (<cite>Mai et al., 2008</cite>).
    </figcaption>
</figure>
